# RFC-0004: Ledger and Settlement State Machine
...
This RFC defines baseline canonical requirements for the ledger and settlement state machine domain in Ryvra's modular architecture.
