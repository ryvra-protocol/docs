# RFC-0007: Markets Intents and Execution
...
This RFC defines baseline canonical requirements for the markets intents and execution domain in Ryvra's modular architecture.
