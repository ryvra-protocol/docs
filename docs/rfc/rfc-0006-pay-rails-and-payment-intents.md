# RFC-0006: Pay Rails and Payment Intents
...
This RFC defines baseline canonical requirements for the pay rails and payment intents domain in Ryvra's modular architecture.
